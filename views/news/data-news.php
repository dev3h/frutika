    ...
    for ($i = 0; $i < $total - 1; $i++) {?>
        <div class="col-lg-4 col-md-6">
            <div class="single-latest-news">
                <a href="./detail-news/<?php echo $result[$i]['url'] ?>.html">
                ...
                <div class="news-text-box">
                    <h3><a href="./detail-news/<?php echo $result[$i]['url'] ?>.html"><?php echo $result[$i]['title'] ?></a></h3>
                    <p class="blog-meta">
                        <span class="author"><i class="fas fa-user"></i> Admin</span>
                        <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
                    </p>
                    <p class="excerpt"><?php echo $result[$i]['content'] ?></p>
                    <a href="./detail-news/<?php echo $result[$i]['url'] ?>.html" class="read-more-btn">đọc thêm <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
        </div>
<?php }
